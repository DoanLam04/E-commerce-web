...
class Checkout extends Component {
  ...
  componentDidMount() {
    if (localStorage.getItem("selectedList"))
      ...
      else this.getGuestShoppingCartList(localStorage.getItem("cartList"));
    else {
  ...
  getShoppingCartList() {
    axios
      .get(`http://localhost:8000/api/product/cart-list/`, {
  ...
  getGuestShoppingCartList(localCartList) {
    axios
      .post("http://localhost:8000/api/product/cart-list/guest", {
  ...
  handleSubmit(e) {
    ...
    axios
      .post("http://localhost:8000/api/user/create-user-address", {
  ...
  getUserDefaultAddress() {
    axios
      .get("http://localhost:8000/api/user/default-address/", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((result) => {
